...
/**
 * @file astarte_device_sdk/mqtt/errors.hpp
 * @brief specific error definitions for the Astarte device SDK.
 *
 * @details This file defines specific error classes derived from ErrorBase,
 * covering various failure scenarios such as MQTT issues, pairing errors,
...
/// @brief Specific error for when the configuration to connect the device to Astarte is invalid.
...
/// @brief Specific MQTT connection error.
