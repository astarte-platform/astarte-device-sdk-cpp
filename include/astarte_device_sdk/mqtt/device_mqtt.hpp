...
class DeviceMqtt : public Device {
 public:
   ...
   * @return An expected conforming to std::expected containing the DeviceMqtt instance on success
   * or Error on failure.
   */
   ...
   * @return An expected conforming to std::expected containing the list of properties on success,
   ...
   * @return An expected conforming to std::expected containing the property on success, or an Error
   * on failure.
   */
