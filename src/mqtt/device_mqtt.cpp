...
auto AstarteDeviceMqtt::create(mqtt::Config cfg) -> astarte_tl::expected<AstarteDeviceMqtt, Error> {
...
auto AstarteDeviceMqtt::connect() -> astarte_tl::expected<void, Error> {
...
auto AstarteDeviceMqtt::disconnect() -> astarte_tl::expected<void, Error> {
...
auto AstarteDeviceMqtt::get_all_properties(const std::optional<Ownership>& ownership)
