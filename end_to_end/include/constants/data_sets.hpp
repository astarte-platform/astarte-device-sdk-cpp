...
struct Integer {
  ...
  static inline const Data DATA = Data(12);
};
...
struct LongInteger {
  ...
  static inline const Data DATA = Data(17179869184);
};
...
struct Double {
  ...
  static inline const Data DATA = Data(54.4);
};
...
struct Boolean {
  ...
  static inline const Data DATA = Data(true);
};
...
struct String {
  ...
  static inline const Data DATA = Data(std::string("Hello C++!"));
};
...
struct Datetime {
  ...
  static inline const Data DATA = Data(std::chrono::system_clock::time_point(
...
struct BinaryBlob {
  ...
  static inline const Data DATA = Data(std::vector<uint8_t>{0x23, 0x43, 0xF5});
};
...
struct IntegerArray {
  ...
  static inline const Data DATA = Data(std::vector<int32_t>{13, 2});
};
...
struct LongIntegerArray {
  ...
  static inline const Data DATA = Data(std::vector<int64_t>{17179869184, 5});
};
...
struct DoubleArray {
  ...
  static inline const Data DATA = Data(std::vector<double>{0.5});
};
...
struct BooleanArray {
  ...
  static inline const Data DATA = Data(std::vector<bool>{false, true});
};
...
struct DatetimeArray {
  ...
  static inline const Data DATA = Data(std::vector<std::chrono::system_clock::time_point>{
      std::chrono::sys_days(std::chrono::year_month_day(
          std::chrono::year(1994), std::chrono::month(4), std::chrono::day(12))) +
          10h + 15min,
      std::chrono::sys_days(std::chrono::year_month_day(
...
struct BinaryBlobArray {
  ...
  static inline const Data DATA =
      Data(std::vector<std::vector<uint8_t>>{{0x23, 0x43, 0xF5}, {0x43, 0xF3, 0x00}});
};
